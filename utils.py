...
# Breaks down images to 8x8 pixel blocks
def to_blocks(image):

    blocks = np.array([image[x:x+8, y:y+8]
...
def to_zeros(array, zeros):
        if zeros == 0:
            return array
        flat_array = array.flatten()
        flat_array[-zeros:] = 0
        rec_array = flat_array.reshape(array.shape)
